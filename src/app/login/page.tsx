      ...
      <main className="mx-auto max-w-[440px] px-5 py-16">
        <div className="rounded-xl border border-border bg-bg-card p-8 card-glow animate-fade-in-up">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="h-4 w-4 rounded border-border bg-bg-input accent-blue" />
                <span className="text-sm text-text-secondary">Remember me</span>
              </label>
              <a href="#" className="text-sm font-medium text-blue-light hover:text-blue transition-colors">Forgot password?</a>
            </div>
          ...
          <p className="text-sm text-text-muted text-center mt-6">
            ...
            <Link href="/register" className="font-semibold text-blue-light hover:text-blue transition-colors">
              Create one
            </Link>
          </p>
        </div>
